...
public class Term extends ActivityBase implements UpdateCallback {
    ...
    private static final int TERM_MENU_COUNT = 7;
    private final static int SELECT_TEXT_ID = 0;
    private final static int COPY_ALL_ID = 1;
    private final static int PASTE_ID = 2;
    private final static int SEND_CONTROL_KEY_ID = 3;
    private final static int SEND_FN_KEY_ID = 4;
    private final static int SEND_UP_KEY_ID = 5;
    private final static int SEND_DOWN_KEY_ID = 6;
    ...
    private final TermMenuItem[] mTermMenuItems = new TermMenuItem[TERM_MENU_COUNT];
    ...
    private final Runnable mBellRunnable = new Runnable() {
        @Override
        public void run() {
            if (mSoundPoll != null) {
    ...
    private final BellListener mBellListener = () -> {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (AndroidCompat.SDK >= Build.VERSION_CODES.HONEYCOMB_MR1) {
        ...
        mTermMenuItems[5] = new TermMenuItem(SEND_UP_KEY_ID, getString(R.string.send_up_key));
        mTermMenuItems[6] = new TermMenuItem(SEND_DOWN_KEY_ID, getString(R.string.send_down_key));

        mViewFlipper = (TermViewFlipper) findViewById(VIEW_FLIPPER);

        PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
        mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, TermDebug.LOG_TAG + ":lock");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_preferences) {
            ...
            PasteHistoryDialog.getInstance(this::doWriteScript).show(getFragmentManager(), "memo");
        }
    ...
    private void confirmCloseWindow() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes,
                        (dialog, id) -> {
                            dialog.dismiss();
                            UiKit.get().post(this::doCloseWindow);
                        })
    ...
    private void doRenameWindow() {
        ...
        b.setPositiveButton(android.R.string.yes,
                (arg0, arg1) -> doChangeWindowTitle(Objects.requireNonNull(editText.getText()).toString()));
        b.setNegativeButton(android.R.string.no, null);
        b.show();
    }

    private void doChangeWindowTitle(final String title) {
        final Runnable typeName = () -> {
            TermSession ts = getCurrentTermSession();
            if (ts == null) {
                return;
            }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        new AlertDialog.Builder(this)
                ...
                .setItems(mTermMenuItems, (dialog, which) -> {
                    dialog.dismiss();
                    ...
                    switch (id) {
                        ...
                        case SEND_FN_KEY_ID:
                            ...
                            break;
                        case SEND_UP_KEY_ID:
                            getCurrentEmulatorView().onKeyDown(KeyEvent.KEYCODE_DPAD_UP, new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_DPAD_UP));
                            getCurrentEmulatorView().onKeyUp(KeyEvent.KEYCODE_DPAD_UP, new KeyEvent(KeyEvent.ACTION_UP, KeyEvent.KEYCODE_DPAD_UP));
                            break;
                        case SEND_DOWN_KEY_ID:
                            getCurrentEmulatorView().onKeyDown(KeyEvent.KEYCODE_DPAD_DOWN, new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_DPAD_DOWN));
                            getCurrentEmulatorView().onKeyUp(KeyEvent.KEYCODE_DPAD_DOWN, new KeyEvent(KeyEvent.ACTION_UP, KeyEvent.KEYCODE_DPAD_DOWN));
                            break;
                    }
                })
    ...
    private void execURL(String link) {
        ...
        final Runnable openLinkRunnable = () -> {
            if (handlers.size() > 0)
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes,
                        (arg0, arg1) -> UiKit.get().post(openLinkRunnable)).setNegativeButton(android.R.string.no, null).show();
    }
    ...
    private static class TermMenuItem implements CharSequence {
